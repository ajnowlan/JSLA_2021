...
export default function App(props) {
  ...
  return (
    <div className="App">
      <img src="https://d2z6c3c3r6k4bx.cloudfront.net/uploads/account/logo/481/display_5385347_300.jpg" alt="" style={{width:"120px",height:"120px" }}></img>
      <h1>Find a Movie</h1>
      <span className="subheading">
        The app will search as you type
      </span>
